...
mongoose.connection.on('open', async () => {
    ...
    const startCard = [{ 
        name: "Myrel, Shield of Argive", type_line: "Legendary Creature - Human Soldier", expansion_symbol: "The Brothers' War (Mythic Rare)", artist_info: "Ryan Pancoast", power_toughness: "3/4", collectors_number: "18",
        text_box: {
        ...
        {
        name: "Force of Will", type_line: "Instant", expansion_symbol: "Dominaria Remastered (Mythic Rare)", artist_info: "Donato Giancola", power_toughness: " ", collectors_number: "50",
        text_box: {
